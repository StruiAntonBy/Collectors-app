...
public class Main2Activity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView.setOnClickListener(v -> {
            if (Image!=null) {
                Intent intent = new Intent(Main2Activity.this, FotoActivity.class);
                intent.putExtra("image", BitmapWork.getArrayByte(Image));
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (title.trim().length() == 0) {
                    ...
                    contentValues.put(DBHelper.KEY_IMAGE, BitmapWork.getArrayByte(Image));
                    database.insert(DBHelper.TABLE_CONTACTS2, null, contentValues);
                    dbHelper.close();
